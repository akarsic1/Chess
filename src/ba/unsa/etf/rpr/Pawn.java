package ba.unsa.etf.rpr;
    ...
    public class Pawn extends ChessPiece {
        ...
        public void move(String potez)throws IllegalChessMoveException{
            ...
            if((trenutni_broj =='7' || trenutni_broj == '2') && slovo == trenutno_slovo && (broj == trenutni_broj+1 || broj == trenutni_broj+2))position = potez;
            else if(broj == trenutni_broj + 1 && slovo == trenutno_slovo ) position = potez;
